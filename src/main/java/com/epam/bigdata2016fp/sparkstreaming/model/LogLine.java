...
public class LogLine implements Serializable {
    ...
    private static final byte[] bidIdBytes = Bytes.toBytes("bidId");
    private String timestamp;
    private static final byte[] timestampBytes = Bytes.toBytes("timestamp");
    private String iPinyouId;
    private static final byte[] iPinyouIdBytes = Bytes.toBytes("iPinyouId");
    private String userAgent;
    private static final byte[] userAgentBytes = Bytes.toBytes("userAgent");
    private String ip;
    ...
    private static final byte[] addExchangeBytes = Bytes.toBytes("addExchange");
    private String domain;
    private static final byte[] domainBytes = Bytes.toBytes("domain");
    private String url;
    private static final byte[] urlBytes = Bytes.toBytes("url");
    private String anonUrl;
    private static final byte[] anonUrlBytes = Bytes.toBytes("anonUrl");
    private String addSlot;
    private static final byte[] addSlotBytes = Bytes.toBytes("addSlot");
    private int addSlotWidth;
    private static final byte[] addSlotWidthBytes = Bytes.toBytes("addSlotWidth");
    private int addSlotHeight;
    private static final byte[] addSlotHeightBytes = Bytes.toBytes("addSlotHeight");
    private int addSlotVisability;
    private static final byte[] addSlotVisabilityBytes = Bytes.toBytes("addSlotVisability");
    private int addSlotFormat;
    private static final byte[] addSlotFormatBytes = Bytes.toBytes("addSlotFormat");
    private int payingPrice;
    private static final byte[] payingPriceBytes = Bytes.toBytes("payingPrice");
    private String creativeId;
    private static final byte[] creativeIdBytes = Bytes.toBytes("creativeId");
    private int biddingPrice;
    private static final byte[] biddingPriceBytes = Bytes.toBytes("biddingPrice");
    private String addvertiseId;
    private static final byte[] addvertiseIdBytes = Bytes.toBytes("addvertiseId");
